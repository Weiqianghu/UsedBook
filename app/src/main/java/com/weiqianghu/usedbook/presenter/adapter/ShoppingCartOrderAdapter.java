 ...
 */
public class ShoppingCartOrderAdapter extends CommonAdapterForRecycleView<ShoppingCartModel> {
    private List<ShoppingCartModel> mData;

    public ShoppingCartOrderAdapter(List<ShoppingCartModel> datas, int itemLayoutId) {
